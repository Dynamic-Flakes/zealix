...
import { ContractAbi } from '../contract-info/zealix';
import QueryMethods from '../query/zealix';
import BuildExtrinsicMethods from '../build-extrinsic/zealix';
import TxSignAndSendMethods from '../tx-sign-and-send/zealix';
import MixedMethods from '../mixed-methods/zealix';
import EventsClass from '../events/zealix';
